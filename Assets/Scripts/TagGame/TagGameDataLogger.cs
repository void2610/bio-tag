...
namespace TagGame
{
    ...
    public class TagGameDataLogger : IDisposable
    {
        ...
        /// 鬼交代イベントを記録
        /// </summary>
        public void RecordItChange(int newItIndex, List<Vector3> playerPositions, float gsrRaw, float gsrFiltered, float gsrThreshold, bool isExcited)
        {
            // 前の鬼の時間を記録
            ...
            // イベントを記録
            RecordEvent("ItChanged", newItIndex, playerPositions, gsrRaw, gsrFiltered, gsrThreshold, isExcited);
        ...
        /// </summary>
        public void RecordGameTick(int currentItIndex, List<Vector3> playerPositions, float gsrRaw, float gsrFiltered, float gsrThreshold, bool isExcited)
        {
            RecordEvent("Tick", currentItIndex, playerPositions, gsrRaw, gsrFiltered, gsrThreshold, isExcited);
        }

        /// <summary>
        /// イベントを記録する共通メソッド
        /// </summary>
        private void RecordEvent(string eventType, int currentItIndex, List<Vector3> playerPositions, float gsrRaw, float gsrFiltered, float gsrThreshold, bool isExcited)
        {
